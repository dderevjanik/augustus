...
typedef enum {
    ...
    TR_EDITOR_RANDOM_MAP_TITLE,
    TR_EDITOR_RANDOM_MAP_SEED,
    TR_EDITOR_RANDOM_MAP_MAP_SIZE,
    TR_EDITOR_RANDOM_MAP_TREE_DENSITY,
    TR_EDITOR_RANDOM_MAP_ROCK_DENSITY,
    TR_EDITOR_RANDOM_MAP_SHRUB_DENSITY,
    TR_EDITOR_RANDOM_MAP_MEADOW_DENSITY,
    TR_EDITOR_RANDOM_MAP_LAKE_COUNT,
    TR_EDITOR_RANDOM_MAP_LAKE_SIZE,
    TR_EDITOR_RANDOM_MAP_RIVER_COUNT,
    TR_EDITOR_RANDOM_MAP_COASTAL,
    TR_EDITOR_RANDOM_MAP_ELEVATION,
    TR_EDITOR_RANDOM_MAP_MAX_ELEVATION,
    TR_EDITOR_RANDOM_MAP_FLATNESS,
    TR_EDITOR_RANDOM_MAP_GENERATE,
    TR_EDITOR_RANDOM_MAP_CANCEL,
    TR_EDITOR_RANDOM_MAP_MENU,
    TRANSLATION_MAX_KEY
} translation_key;
