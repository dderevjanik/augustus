...
typedef enum {
    ...
    TR_MAIN_MENU_DOWNLOAD_SCENARIOS,
    TR_WINDOW_SCENARIO_DOWNLOAD_TITLE,
    TR_WINDOW_SCENARIO_DOWNLOAD_COL_NAME,
    TR_WINDOW_SCENARIO_DOWNLOAD_COL_RATING,
    TR_WINDOW_SCENARIO_DOWNLOAD_COL_AUTHOR,
    TR_WINDOW_SCENARIO_DOWNLOAD_COL_UPDATED,
    TR_WINDOW_SCENARIO_DOWNLOAD_COL_RELEASED,
    TR_WINDOW_SCENARIO_DOWNLOAD_FETCHING,
    TR_WINDOW_SCENARIO_DOWNLOAD_FETCH_ERROR,
    TR_WINDOW_SCENARIO_DOWNLOAD_DOWNLOADED,
    TR_WINDOW_SCENARIO_DOWNLOAD_DOWNLOADING,
    TRANSLATION_MAX_KEY
} translation_key;
