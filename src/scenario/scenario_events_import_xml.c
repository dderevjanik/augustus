...
static special_attribute_mapping_t *scenario_events_get_attribute_mapping(const char *value, special_attribute_mapping_t array[], int array_size)
{
...
static int xml_import_special_parse_building(xml_data_attribute_t *attr, int *target)
{
    ...
    special_attribute_mapping_t *found = scenario_events_get_attribute_mapping(
