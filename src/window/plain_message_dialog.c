...
{
    if (init(title, message, 1, extra, 0)) {
        window_type window = {
            WINDOW_PLAIN_MESSAGE_DIALOG,
            draw_background,
            draw_foreground,
...
void window_plain_message_dialog_show_with_two_extra(translation_key title, translation_key message, const uint8_t *extra, const uint8_t *extra2)
{
