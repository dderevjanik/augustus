...
static generic_button buttons[] = {
    {SHORT_BUTTON_LEFT_PADDING, EVENT_REPEAT_Y_OFFSET, SHORT_BUTTON_WIDTH, 14, button_amount, button_none, 11, 0},
    {SHORT_BUTTON_LEFT_PADDING, EVENT_REPEAT_Y_OFFSET + 32, SHORT_BUTTON_WIDTH, 14, button_amount, button_none, 12, 0},
    {SHORT_BUTTON_LEFT_PADDING, EVENT_REPEAT_Y_OFFSET + 64, SHORT_BUTTON_WIDTH, 14, button_amount, button_none, 13, 0},
...
static void draw_foreground(void)
{
    ...
    for (int i = 0; i < MAX_VISIBLE_ROWS; i++) {
        if (data.list[i].sub_type != SUB_ITEM_TYPE_UNDEFINED) {
            ...
            if (strcmp(data.list[i].xml_parm1_name, "")) {
            ...
            if (strcmp(data.list[i].xml_parm2_name, "")) {
            ...
            if (strcmp(data.list[i].xml_parm3_name, "")
                || strcmp(data.list[i].xml_parm4_name, "")
                || strcmp(data.list[i].xml_parm5_name, "")) {
