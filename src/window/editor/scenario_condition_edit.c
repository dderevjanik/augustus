...
{
    if (param1 == 1) {
        change_parameter(&data.xml_info->xml_parm1, param1);
    } else if (param1 == 2) {
        change_parameter(&data.xml_info->xml_parm2, param1);
    } else if (param1 == 3) {
        change_parameter(&data.xml_info->xml_parm3, param1);
    } else if (param1 == 4) {
        change_parameter(&data.xml_info->xml_parm4, param1);
    } else if (param1 == 5) {
        change_parameter(&data.xml_info->xml_parm5, param1);
    }
}
